...
RAUC_FEATURE = Feature(
    name="rauc-simple",
    description="RAUC support with update bundles via update script",
    includes=[
        FeatureInclude(
            "meta-moonforge", "kas/include/layer/meta-moonforge-rauc-update.yml"
        ),
    ],
    local_conf=[
        FeatureFragment(
            section="meta-moonforge-rauc-update",
            weight=40,
            key="RAUC_BUNDLE_URL",
    ...
    machine_overrides={
        "local_conf": {
            "qemux86-64": [
                FeatureFragment(
                    section="meta-moonforge-rauc-qemu",
                    weight=40,
                    key="WKS_FILE",
            ...
            "raspberrypi5": [
                FeatureFragment(
                    section="meta-moonforge-rauc-raspberry",
                    weight=40,
                    key="WKS_FILE",
        ...
        "includes": {
            "qemux86-64": [
                FeatureInclude(
                    "meta-moonforge", "kas/include/layer/meta-moonforge-rauc-qemu.yml"
                ),
            ],
            "raspberrypi5": [
                FeatureInclude(
    ...
    variables=[
        FeatureVariable(
            name="RAUC_FORCE_REBOOT_ON_UPDATE",
